...
public class BorrowBook implements bcu.Group_F6.librarysystem.commands.Command {
    ...
    public void execute(Library library, LocalDate currentDate) throws LibraryException {
        ...
        if (patron.getBooks().size() >= 2) {
            throw new LibraryException("Patron has reached the maximum number of borrowed books (2).");
        }
