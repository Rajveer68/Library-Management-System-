...
public class LoanDataManager implements DataManager {
    ...
    public void loadData(Library library) throws IOException, LibraryException {
        ...
        if (!f.exists()) {
             System.out.println("LoanDataManager: " + f.getAbsolutePath() + " not found. Checking alternative path...");
             f = new File("InteractiveLibrarySystem_dist/resources/data/loans.txt");
             if (!f.exists()) {
                  f = new File("src/resources/data/loans.txt");
             }
             
             if (!f.exists()) {
                  System.out.println("LoanDataManager: Could not find loans.txt. No loans loaded.");
                  return;
             }
        }
        System.out.println("Loading loans from: " + f.getAbsolutePath());
